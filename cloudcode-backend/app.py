...
def analyze_code_batch_with_gemini(code_batch):
    ...
    try:
        ...
        # Return a list with an error object to ensure the frontend can display it
        return [{
...
def analyze_project():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        try:
            ...
            code_issues = analyze_dependency_vulnerabilities(temp_dir)
...
def analyze_dependency_vulnerabilities(repo_dir):
    """Scans for vulnerabilities in dependency files (for /analyze endpoint)."""
